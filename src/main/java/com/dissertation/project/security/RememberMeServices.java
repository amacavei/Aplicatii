...
import static com.dissertation.project.config.SecurityConfig.REMEMBER_ME_KEY;
...
public class RememberMeServices extends AbstractRememberMeServices {
    ...
    //One month availability for token
    private static final int TOKEN_VALIDITY_DAYS = 31;
    private static final int TOKEN_VALIDITY_SECONDS = 60 * 60 * 24 * TOKEN_VALIDITY_DAYS;
    private static final int DEFAULT_SERIES_LENGHTH = 16;
    ...
    private Tokens getPersistentToken(String[] cookieTokens) {
        ...
        //There is a match for this user or series  combination
    ...
    private String generateSeriesData() {
        byte[] newSeries = new byte[DEFAULT_SERIES_LENGHTH];
